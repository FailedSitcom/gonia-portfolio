...
<BlogColumn>
  ...
  <ColumnText>
    <p>
      ...
      through <strong>personas</strong> and, now very retro-looking, persona sheets.
    </p>
  </ColumnText>
</BlogColumn>

<Image filename="rhspca.png" alt={"Persona sheet: Rose"} />
<Image filename="rhspca-2.png" alt={"Persona sheet: Jo"} />
<Image filename="rhspca-3.png" alt={"Persona sheet: Jack"} />
<Image filename="rhspca-4.png" alt={"Persona sheet: Jack and Mia"} />
...
<BlogColumn>
  ...
  <ColumnText>
    <p>
      ...
      <br />- Integrate Facebook and other social media account updates into the
      blog feed.
    </p>
  </ColumnText>
</BlogColumn>
...
<Image filename="rhspca-5.png" alt={"Basic retro wireframe for a homepage update"} />
